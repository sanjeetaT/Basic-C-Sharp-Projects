...
namespace TwentyOne
{
    public class TwentyOneRules
    {
        ...
        {
            int[] possibleValues = GetAllPossibleHendValues(Hand);
        ...
        {
            int value = GetAllPossibleHendValues(Hand).Min();
            if (value == 21) return true;
            else return false;
        }
    ...
    public static bool ShouldDealerStay(List<Card> Hand)
        {
            ...
            {
                int[] playerResults = GetAllPossibleHendValues(PlayerHand);
                int[] dealerResults = GetAllPossibleHendValues(DealerHand);
